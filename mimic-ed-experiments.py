...
for r in range(5):
  ...
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[271] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[271,271] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[271,271,271] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[542] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[542,542] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[542,542,542] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[1084] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[1084,1084] --runName=Att_c-MIMIC-9722_', shell=True)
  ...
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google-test.py "../clinical-prediction/data/mimic-ed/both/mimic-ed_90-10_9722"' + " \"" + best_model + "\"" + ' --hiddenDimSize=[1084,1084,1084] --runName=Att_c-MIMIC-9722_', shell=True)

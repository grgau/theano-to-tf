...
for r in range(3):
  # # cell [391]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[391] --maxConsecutiveNonImprovements=10', shell=True)
  ...
  # # cell [391, 391]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[391,391] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [391, 391, 391]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[391,391,391] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [783]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[783] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [783, 783]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[783,783] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [783, 783, 783]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[783,783,783] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [1566]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[1566] --maxConsecutiveNonImprovements=10',shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [1566, 1566]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[1566,1566] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [1566, 1566, 1566]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[1566,1566,1566] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [3133]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[3133] --maxConsecutiveNonImprovements=10',shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [3133, 3133]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[3133,3133] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # # cell [3133, 3133, 3133]
  # stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=cell --hiddenDimSize=[3133,3133,3133] --maxConsecutiveNonImprovements=10', shell=True)
  # best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [391]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[391] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [391, 391]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[391,391] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [391, 391, 391]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[391,391,391] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [783]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[783] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [1566]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[1566] --maxConsecutiveNonImprovements=10',shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [1566, 1566]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[1566,1566] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[1566,1566,1566] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [3133]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[3133] --maxConsecutiveNonImprovements=10',shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [3133, 3133]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[3133,3133] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-incor/incor_90-10_3133" compiled_models/incor-dt-lstm-model --state=hidden --hiddenDimSize=[3133,3133,3133] --maxConsecutiveNonImprovements=10', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]

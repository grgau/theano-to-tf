...
if __name__ == '__main__':
  ...
  # print subjectTOhadms_Map # Posso buscar pelo CODEs_List[1] como value aqui
  ...
  # print subjectTOorderedHADM_IDS_Map
  ...
  for subject_id, time_ordered_CODESs_List in subjectTOorderedHADM_IDS_Map.iteritems():
    ...
    for admission in time_ordered_CODESs_List:   		#each element in time_ordered_CODESs_List is a tripple (admittime, ICD9_List, hadm_id)
      ...
      subject_list_of_CODEs_List.append((admission[1],admission[2],subject_id))  #build list of lists of the admissions' CODEs of the current subject_id, stores hadm_id together
  ...
  # print all_subjectsListOfCODEsList_LIST
  ...
  # print all_subjectsListOfCODEsList_LIST # [(['D997', 'D482', 'D579', 'D458', 'D271', 'D398', 'D518', 'D519', 'DV43', 'D391', 'D427'], 135989), --- 135989 eh o hadm_id
  procCODEstoInternalID_map = {}
  for subject_list_of_CODEs_List in all_subjectsListOfCODEsList_LIST:
    # print subject_list_of_CODEs_List # (['D440', 'D441', 'D493', 'D789', 'D482', 'D997', 'D584', 'D412', 'D272', 'D518', 'D263', 'D401', 'D276', 'D557', 'DE87', 'D511', 'D427', 'DV45', 'D287'], 126132), (['D997', 'D560', 'D493', 'D578', 'D236', 'D569', 'DV15', 'DV58', 'D553', 'D272', 'D428', 'DV10', 'DE87', 'D414', 'D427', 'DV45'], 165601)] ....
    # print subject_list_of_CODEs_List
    ...
    for CODEs_List in subject_list_of_CODEs_List:
      ...
      subject_id = CODEs_List[2]


      # mapped_subject_id = [key for key, value in subjectTOhadms_Map.items() if hadm_id in value] # find subject_ids in hadm_id mapping
      ...
      subject_idList.append(subject_id)
      ...
      if hadm_id == 115264 or hadm_id == 176315 or hadm_id == 199856:
        teste = new_CODEs_List

      # subjects_mapping[mapped_subject_id[0]] = new_subject_list_of_CODEs_List # populate dict subject_id is the key and list of list of codes the value
    ...
    # print new_subject_list_of_CODEs_List # [[255, 76, 122, 81, 5], [33, 79, 119, 1...
    ...
    if len(new_subject_list_of_CODEs_List) > 1:
      ...
      new_all_subjects_ids_LIST.append(subject_idList[0])

      # print subjects_mapping.keys()[subjects_mapping.values().index(new_subject_list_of_CODEs_List)]

      if len(ARGS.procedures_file) > 0:
        new_all_subjects_list_of_ProcCodes_List.append(new_subject_list_of_ProcCODEs_List)

  print ''
  print CCS_ordered_internalCodesMap
  nCodes = len(CCS_ordered_internalCodesMap) # 'D390': 825, 'D145': 736, 'D983': 795...
  ...
  # print new_all_subjectsListOfCODEsList_LIST # [[76, 125, 22, 156, 56, 55, 208, 87, 1,...
  ...
  print '-Final number of subjects_ids: ' + str(len(new_all_subjects_ids_LIST))

  # for subject_list, subject_map in zip(new_all_subjectsListOfCODEsList_LIST, subjects_mapping.values()):
  # 	print subject_list
  # 	print subject_map
  # 	print '\n'

  print new_all_subjectsListOfCODEsList_LIST[0]
  print new_all_subjects_ids_LIST[0]
  print duration_of_admissionsListOfLists[0]
  print interval_since_last_admissionListOfLists[0]
  print type_of_admissionsListOfLists[0]
  ...
  if (len(partitions) >= 1):
    ...
    pickle.dump(new_all_subjects_ids_LIST[0:index_of_last_patient_to_dump], open(ARGS.output_prefix + '_' + str(nCodes) + '.map.train', 'wb'), -1)
    ...
    if (len(partitions) >= 2):
      print 'Writing ' + str(partitions[1]) + '% of the hadmToMappatients read from file ' + ARGS.admissions_file
      ...
      pickle.dump(new_all_subjects_ids_LIST[index_of_first_patient_to_dump:index_of_last_patient_to_dump], open(ARGS.output_prefix + '_' + str(nCodes) + '.map.test', 'wb'), -1)
      ...
      if (len(partitions) >= 3):
        ...
        pickle.dump(new_all_subjects_ids_LIST[index_of_first_patient_to_dump:], open(ARGS.output_prefix + '_' + str(nCodes) + '.map.valid', 'wb'), -1)

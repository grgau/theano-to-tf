...
for r in range(5):
  # cell [271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[271]', shell=True)
  ...
  with open(str(r) + '_lstm-mimic-855-experiments.txt', 'a') as f:
  ...
  # cell [271, 271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[271,271]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [271, 271, 271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[271,271,271]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [542, 542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[542,542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [542, 542, 542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[542,542,542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [1084]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [1084, 1084]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[1084,1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # cell [1084, 1084, 1084]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=cell --hiddenDimSize=[1084,1084,1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[271]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [271, 271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[271,271]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [271, 271, 271]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[271,271,271]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [542, 542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[542,542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [542, 542, 542]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[542,542,542]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [1084]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  # hidden [1084, 1084]
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[1084,1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
  ...
  stdout = subprocess.check_output('python3.7 src/tf/LSTM-tf-Google.py "src/data-apehr-preprocessed/mimic_90-10_855" compiled_models/855-lstm-model --state=hidden --hiddenDimSize=[1084,1084,1084]', shell=True)
  best_model = stdout.decode().split("\n")[-5].split(" ")[-1]
